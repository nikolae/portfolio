...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="http://localhost:4000" class="icon-tree"> Nick Aroneseno: A technical journey</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/blog/">Posts</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/blog/archive/">Archives</a></li>
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/tags/software">Software</a></li>
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/tags/hardware">Hardware</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Nick Aroneseno: A technical journey – A personal archive">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Nick Aroneseno: A technical journey – A personal archive">
			</a>
